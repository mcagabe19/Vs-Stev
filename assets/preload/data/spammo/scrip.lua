...
songPos = getSongPosition()
		local currentBeat = (songPos/5000)*(curBpm/2)
		...
		noteTweenX(defaultPlayerStrumX2, 6, defaultPlayerStrumX2 + 1000*math.sin((currentBeat+4*0.25)*math.pi), 0.5)
		...
		noteTweenX(defaultOpponentStrumX1, 1, defaultOpponentStrumX1 - 1000*math.sin((currentBeat+4*0.25)*math.pi), 0.5)
